...
const Day: React.FC<{ n: number; filled: "active" | "special" | "empty"; delay: number }> = ({
  n,
  filled,
  delay,
}) => {
  ...
  const src =
    filled === "active"
      ? "images/clover-active.svg"
      : filled === "special"
        ? "images/clover-special.svg"
        : "images/clover-empty.svg";
  return (
    <div
      style={{
        aspectRatio: "1",
    ...
    >
      <Img
        src={staticFile(src)}
        style={{ width: 88, height: 88, transform: `scale(${interpolate(s, [0, 1], [0.6, 1])})` }}
      />
  ...
  return (
    <AbsoluteFill style={{ background: COLORS.bg }}>
      ...
      >
        ...
        <div style={{ fontFamily: FF_KO, fontSize: 32, opacity: 0.85, marginTop: 16 }}>
          11월 · 28개의 기록
        </div>
      </div>
      {/* 캘린더 카드 */}
