...
export const Scene3Record: React.FC = () => {
  ...
  const charsToShow = Math.floor(
    interpolate(frame, [45, 88], [0, text.length], {
  ...
  return (
    <AbsoluteFill style={{ background: COLORS.bg, padding: "120px 60px 80px" }}>
          ...
          return (
            <div
              ...
              style={{
                ...
                gap: 14,
                opacity: itemS,
                transform: `translateY(${interpolate(itemS, [0, 1], [20, 0])}px) scale(${selScale})`,
              }}
            >
              <div
                style={{
                  ...
                  display: "grid",
                  placeItems: "center",
                  border: selected ? `4px solid ${COLORS.primary}` : "none",
                }}
              >
      ...
      >
        <div style={{ fontFamily: FF_KO, fontSize: 30, color: COLORS.subtext, marginBottom: 22 }}>
          오늘의 기록
        </div>
        <div
          style={{
        ...
        >
          ...
          <span style={{ opacity: Math.floor(frame / 4) % 2 === 0 ? 1 : 0, color: COLORS.primary }}>
            |
          </span>
        </div>
      </div>
