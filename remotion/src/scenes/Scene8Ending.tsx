...
export const Scene8Ending: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: COLORS.skyGradient, alignItems: "center", justifyContent: "center" }}>
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 40 }}>
        ...
        />
        <div style={{
          fontFamily: FF_KO, fontSize: 110, color: "white", letterSpacing: -3,
          opacity: textS, transform: `translateY(${interpolate(textS, [0, 1], [20, 0])}px)`,
        }}>
          안다미로
        </div>
        <div style={{
          fontFamily: FF_KO, fontSize: 44, color: "white", opacity: subS * 0.95,
