...
export const Scene5Fortune: React.FC = () => {
  ...
  const cookieY = interpolate(frame, [50, 65], [0, -40], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  });

  const rayRotate = (frame - 65) * 1.5;
  const rayOpacity = interpolate(frame, [65, 90], [0, 0.7], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  });
  const rayScale = interpolate(frame, [65, 95], [0.6, 1.2], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  });
