...
const SLIDES: SlideData[] = [
  ...
  {
    category: "주요 기능 03",
    title: "오늘의 일기로 분석: 기록을 한눈에 돌아봐요",
    body: "감정 점수와 요약, AI 조언을 통해 오늘의 감정 흐름을 더 명확하게 확인할 수 있습니다.",
  ...
  {
    category: "주요 기능 04",
    title: "리포트: 나의 감정 흐름을 발견해요",
    body: "쌓인 기록을 바탕으로 분석한 통계와 인사이트로 나를 더 잘 이해할 수 있도록 돕습니다.",
