...
const TYPE_SCALE = [
  ...
  { name: "Body Strong",    size: 16, weight: 600, lh: 1.40, ls: "-0.02em",  usage: "버튼·카드 제목·리스트",    files: ["index", "record", "exchange", "exchange.create", "exchange.$roomId", "video-record", "diary", "fortune", "backup", "analysis", "my", "login", "Splash", "EmptyDiaryState", "PageHeader", "BottomSheet", "FaceAnalysisOverlay"] },
  { name: "Body",           size: 16, weight: 400, lh: 1.70, ls: "-0.01em",  usage: "본문 텍스트·댓글",         files: ["index", "record", "exchange", "exchange.create", "exchange.$roomId", "video-record", "diary", "fortune", "backup", "analysis", "my"] },
  ...
  { name: "Caption",        size: 14, weight: 400, lh: 1.45, ls: "0em",      usage: "서브타이틀·설명",          files: ["index", "exchange", "exchange.$roomId", "video-record", "fortune", "advice", "diary", "chat", "report", "analysis", "my", "BottomSheet", "EmptyDiaryState", "EmptyState", "FaceAnalysisOverlay"] },
  { name: "Micro Bold",     size: 12, weight: 700, lh: 1.30, ls: "0.06em",   usage: "배지 레이블·CAPS 섹션명",  files: ["analysis", "video-record", "diary", "advice", "report", "my", "BottomNav", "FaceAnalysisOverlay"] },
  { name: "Micro",          size: 12, weight: 400, lh: 1.45, ls: "0em",      usage: "타임스탬프·메타 (최솟값)", files: ["index", "record", "exchange", "exchange.create", "exchange.$rowId", "video-record", "advice", "diary", "chat", "report", "analysis", "my", "backup"] },
];
