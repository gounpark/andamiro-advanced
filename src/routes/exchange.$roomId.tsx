          ...
          <article>
            ...
            {diary.viewerIds.length > 0 && (
              <div className="mx-4 mt-4 rounded-2xl bg-white border border-[#f0f0f0] px-4 py-3">
                ...
                {isAuthor && diary.viewerNames.length > 0 && (
                  <div className="flex flex-wrap gap-1 pt-1 border-t border-[#f5f5f5]">
                    {diary.viewerNames.map((name, i) => (
                      <span
                        key={diary.viewerIds[i]}
                        className="text-[11px] text-[#777] bg-[#f4f6fa] px-2 py-0.5 rounded-full tracking-tight"
                      >
                        {name}
                      </span>
                    ))}
